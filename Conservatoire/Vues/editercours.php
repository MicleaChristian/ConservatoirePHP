...
<body>
    ...
    <div class="position-relative mt-5 mb-3">
        <h2 class="d-flex justify-content-center mt-5">Modifier les informations de <?php echo $seance->getJOUR() . " " . $seance->getTRANCHE(); ?></h2>
    </div>
    ...
    <form action="index.php?uc=cours&action=editer&idseance=<?php echo $seance->getNUMSEANCE(); ?>" method="post">
            ...
            <div class="row mt-3">
                ...
                <div class="col">
                    ...
                    <input type="number" class="form-control" id="capacite" name="capacite" value="<?php echo $seance->getCAPACITE(); ?>">
                </div>
            </div>
